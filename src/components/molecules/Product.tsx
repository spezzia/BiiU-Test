...
export default function Product({ id, url, name, price, category }: ProductProps) {
  return (
    <Link href={`/product/${id}`}>
      <div className="flex flex-col w-fit max-w-[155px] md:max-w-[286px]">
        ...
        <p className="font-outfit text-[14px] md:text-[16px] font-normal line-clamp-1 text-[#334155] uppercase">
          {category}
        </p>
